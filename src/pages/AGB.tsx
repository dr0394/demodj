          ...
          <div className="space-y-6 text-gray-300">
            ...
            <div>
              ...
              <p>
                ...
                zwischen Heiko Banaszak (nachfolgend DJ Jackobeat genannt) und seinen Vertragspartnern (Kunden).
              </p>
            </div>

            <div>
              <h3 className="text-xl font-semibold text-white mb-3">2. Vertrag</h3>
              <p>Verträge zwischen DJ Jackobeat und dem Kunden entstehen durch</p>
            ...
            <div>
              ...
              <p className="mt-3 font-semibold text-white">Ein Rücktritt von DJ Jackobeat ist möglich:</p>
              <p className="mt-2">
                Sollte DJ Jackobeat auf Grund eines Corona Infekts plötzlich erkranken und ausfallen, dann besteht kein Anspruch auf Ersatz. DJ Jackobeat wird sich aber um einen Ersatz DJ bemühen.
              </p>
              <ul className="list-disc list-inside mt-2 space-y-1 ml-4">
              ...
              <p className="mt-3">
                In den vorgenannten Fällen (außer im Todesfall) wird DJ Jackobeat versuchen, für einen entsprechenden Ersatz-DJ zu den vereinbarten Konditionen zu sorgen. Ein Rechtsanspruch besteht jedoch nicht.
              </p>
              <p className="mt-3">
                Ein Rücktritt vom Vertrag / Buchung ist schnellstmöglich schriftlich oder fernmündlich dem DJ Jackobeat zur Kenntnis zu geben.
              </p>
            </div>
            ...
            <div>
              ...
              <p>
                Für Personen- und/oder Sachschäden während einer Veranstaltung haftet ausschließlich der Veranstalter, sofern durch grob fahrlässiges oder vorsätzliches Verhalten von DJ Jackobeat der Schaden verursacht worden ist, ist der Veranstalter von der Haftung befreit.
              </p>
              <p className="mt-3">
                Für Schäden an Equipment und Musikdatenträgern von DJ Jackobeat, die während der Veranstaltung durch Gäste / Publikum fahrlässig, grob fahrlässig oder vorsätzlich verursacht werden, haftet der Veranstalter.
              </p>
              <p className="mt-3">
                Sofern DJ Jackobeat durch nicht durch ihn zu verantwortende Umstände (höhere Gewalt, Naturkatastrophen, behördliche Anordnungen, Betriebsstörungen beim Veranstalter, Stromausfall- und / oder Stromschwankungen) die vereinbarten Leistungen nicht erbringen kann, hat der Kunde kein Recht auf Rücktritt vom Vertrag, keinen Anspruch auf Schadensersatz, kein Recht auf Zurückhaltung einer Zahlung.
              </p>
              <p className="mt-3">
                Kommt es zu Auseinandersetzungen zwischen Gästen / Publikum im Veranstaltungsraum ist DJ Jackobeat berechtigt das Programm zu unterbrechen, ggf. auch ganz abzubrechen – ohne Leistungsabzug.
              </p>
            </div>
            ...
            <div>
              ...
              <p className="mt-3">
                Nur bei schriftlicher Vereinbarung ist eine Zahlung per Überweisung auf das Konto von DJ Jackobeat möglich. Die Kontodaten werden dem Veranstalter im Vertrag gesondert genannt.
              </p>
            </div>
            ...
            <div>
              ...
              <p>
                DJ Jackobeat ist in der Programmgestaltung frei. Er unterliegt keinerlei Weisungen vom Veranstalter oder eines Dritten. Jedoch wird DJ Jackobeat bemüht sein, Musikwünsche zu erfüllen. Ein Anspruch auf Erfüllung eines jeden Musikwunsches besteht jedoch nicht.
              </p>
              <p className="mt-3">
            ...
            <div>
              ...
              <p>
                DJ Jackobeat überträgt dem Veranstalter das Recht, auf Veranstaltungsankündigungen mittels Plakaten, Flyern, etc. den Künstlernamen "DJ Jackobeat" zu veröffentlichen. Es ist dem DJ Jackobeat ein Plakat oder Flyer, etc. vor Veröffentlichung zur Ansicht auszuhändigen.
              </p>
              <p className="mt-3">
                DJ Jackobeat ist berechtigt in eigener Sache Werbung vor / während / oder nach einer Veranstaltung in einer ihn frei wählbaren Form z.B. Aushändigung von Visitenkarten zur Kundenneugewinnung zu machen.
              </p>
              <p className="mt-3">
                Unter Umständen werden Fotos von den jeweiligen Veranstaltungen auf der Webseite von DJ Jackobeat veröffentlicht. Bilder die nicht veröffentlicht werden sollen, können mit einer Nachricht an DJ Jackobeat wieder von der Webseite entfernt werden.
              </p>
              <p className="mt-3">
                Es besteht auch kein Anspruch auf Aufnahme in der Referenzliste auf der Webseite von DJ Jackobeat. Die Auswahl behält sich DJ Jackobeat selber vor.
              </p>
            </div>
            ...
            <div>
              ...
              <p>
                Auf alle Rechtsbeziehungen zwischen DJ Jackobeat und dem Kunden findet das Recht der Bundesrepublik Deutschland Anwendung. Als Erfüllungsort und Gerichtsstandort, soweit rechtlich zulässig, wird Demmin vereinbart.
              </p>
            </div>
