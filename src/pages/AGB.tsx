        ...
        <div className="bg-white/10 border border-white/20 rounded-2xl p-8 md:p-12 backdrop-blur-sm">
          ...
          <div className="space-y-6 text-gray-300">
            ...
            <div>
              ...
              <p>Verträge zwischen DJDEMO und dem Kunden entstehen durch</p>
            ...
            <div>
              ...
              <p className="mt-3 font-semibold text-white">Ein Rücktritt von DJDEMO ist möglich:</p>
              <p className="mt-2">
                Sollte DJDEMO auf Grund eines Corona Infekts plötzlich erkranken und ausfallen, dann besteht kein Anspruch auf Ersatz. DJDEMO wird sich aber um einen Ersatz DJ bemühen.
              </p>
              <ul className="list-disc list-inside mt-2 space-y-1 ml-4">
              ...
              <p className="mt-3">
                In den vorgenannten Fällen (außer im Todesfall) wird DJDEMO versuchen, für einen entsprechenden Ersatz-DJ zu den vereinbarten Konditionen zu sorgen. Ein Rechtsanspruch besteht jedoch nicht.
              </p>
              <p className="mt-3">
                Ein Rücktritt vom Vertrag / Buchung ist schnellstmöglich schriftlich oder fernmündlich dem DJDEMO zur Kenntnis zu geben.
              </p>
            </div>
            ...
            <div>
              ...
              <p>
                Für Personen- und/oder Sachschäden während einer Veranstaltung haftet ausschließlich der Veranstalter, sofern durch grob fahrlässiges oder vorsätzliches Verhalten von DJDEMO der Schaden verursacht worden ist, ist der Veranstalter von der Haftung befreit.
              </p>
              <p className="mt-3">
                Für Schäden an Equipment und Musikdatenträgern von DJDEMO, die während der Veranstaltung durch Gäste / Publikum fahrlässig, grob fahrlässig oder vorsätzlich verursacht werden, haftet der Veranstalter.
              </p>
              <p className="mt-3">
                Sofern DJDEMO durch nicht durch ihn zu verantwortende Umstände (höhere Gewalt, Naturkatastrophen, behördliche Anordnungen, Betriebsstörungen beim Veranstalter, Stromausfall- und / oder Stromschwankungen) die vereinbarten Leistungen nicht erbringen kann, hat der Kunde kein Recht auf Rücktritt vom Vertrag, keinen Anspruch auf Schadensersatz, kein Recht auf Zurückhaltung einer Zahlung.
              </p>
              <p className="mt-3">
                Kommt es zu Auseinandersetzungen zwischen Gästen / Publikum im Veranstaltungsraum ist DJDEMO berechtigt das Programm zu unterbrechen, ggf. auch ganz abzubrechen – ohne Leistungsabzug.
              </p>
            </div>
            ...
            <div>
              ...
              <p className="mt-3">
                Nur bei schriftlicher Vereinbarung ist eine Zahlung per Überweisung auf das Konto von DJDEMO möglich. Die Kontodaten werden dem Veranstalter im Vertrag gesondert genannt.
              </p>
            </div>
            ...
            <div>
              ...
              <p>
                DJDEMO ist in der Programmgestaltung frei. Er unterliegt keinerlei Weisungen vom Veranstalter oder eines Dritten. Jedoch wird DJDEMO bemüht sein, Musikwünsche zu erfüllen. Ein Anspruch auf Erfüllung eines jeden Musikwunsches besteht jedoch nicht.
              </p>
              <p className="mt-3">
            ...
            <div>
              ...
              <p>
                DJDEMO überträgt dem Veranstalter das Recht, auf Veranstaltungsankündigungen mittels Plakaten, Flyern, etc. den Künstlernamen "DJDEMO" zu veröffentlichen. Es ist dem DJDEMO ein Plakat oder Flyer, etc. vor Veröffentlichung zur Ansicht auszuhändigen.
              </p>
              <p className="mt-3">
                DJDEMO ist berechtigt in eigener Sache Werbung vor / während / oder nach einer Veranstaltung in einer ihn frei wählbaren Form z.B. Aushändigung von Visitenkarten zur Kundenneugewinnung zu machen.
              </p>
              <p className="mt-3">
                Unter Umständen werden Fotos von den jeweiligen Veranstaltungen auf der Webseite von DJDEMO veröffentlicht. Bilder die nicht veröffentlicht werden sollen, können mit einer Nachricht an DJDEMO wieder von der Webseite entfernt werden.
              </p>
              <p className="mt-3">
                Es besteht auch kein Anspruch auf Aufnahme in der Referenzliste auf der Webseite von DJDEMO. Die Auswahl behält sich DJDEMO selber vor.
              </p>
            </div>
