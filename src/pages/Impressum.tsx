        ...
        <div className="bg-white/10 border border-white/20 rounded-2xl p-8 md:p-12 backdrop-blur-sm">
          ...
          <div className="space-y-6 text-gray-300">
            <div>
              ...
              <p className="text-lg">
                <strong className="text-white">DJ Jackobeat</strong>
              </p>
            ...
            <div>
              ...
              <p>Website: <a href="https://www.djjackobeat.de" className="hover:opacity-80 transition-colors" style={{ color: '#0EA5E9' }}>www.djjackobeat.de</a></p>
            </div>
