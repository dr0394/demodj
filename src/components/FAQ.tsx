...
const FAQ = () => {
  ...
  const faqs = [
    ...
    },
    {
      ...
      answer: 'Spezialisiert auf 80er & 90er Hits! Dazu spielen wir Charts, Pop, Rock, Disco, Dance Classics und mehr – wir haben für jeden Geschmack die richtige Musik. Ihre Musikwünsche sind herzlich willkommen!'
    },
    {
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="max-w-4xl mx-auto space-y-4">
          {faqs.map((faq, index) => (
            <div
              key={index}
              className="bg-black border border-white/10 rounded-xl overflow-hidden backdrop-blur-sm transition-all hover:border-cyan-500/50"
            >
              <button
              ...
              >
                <div className="flex items-start space-x-4 flex-1">
                  <HelpCircle className="w-6 h-6 flex-shrink-0 mt-1" style={{ color: '#0EA5E9' }} />
        ...
        <div className="mt-16 text-center">
          <div className="bg-black border border-white/10 rounded-2xl p-8 inline-block">
            ...
            <button
              ...
              className="bg-gradient-to-r from-cyan-500 to-cyan-600 text-black px-10 py-4 rounded font-bold text-lg hover:shadow-lg hover:shadow-cyan-500/50 transition-all transform hover:scale-105"
            >
