        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 mb-12">
          {equipment.map((item, index) => (
            <div
              ...
              className="group relative bg-gradient-to-br from-slate-900/80 to-slate-800/80 backdrop-blur-sm border border-white/10 rounded-lg p-8 hover:border-cyan-500/30 transition-all duration-500 overflow-hidden cursor-pointer"
            >
              ...
              <div className="relative space-y-4">
                ...
                >
                  <item.icon className="w-8 h-8" style={{ color: '#0EA5E9' }} />
                </div>
          ...
          <div className="relative w-full max-w-2xl bg-gradient-to-br from-slate-900 to-slate-800 border border-white/10 rounded-lg p-8">
            ...
            <div className="space-y-6">
              <div className="flex items-start gap-4">
                ...
                >
                  <selectedEquipment.icon className="w-8 h-8" style={{ color: '#0EA5E9' }} />
                </div>
                <div>
