...
const Gallery = () => {
  ...
  const images = [
    {
      url: 'https://alkaio.com/media/889623693444528.jpeg',
      title: 'DJ Equipment Setup',
      category: 'Technik'
    },
    {
      url: 'https://alkaio.com/media/34044312911849273.jpeg',
      title: 'Professional DJ Gear',
      category: 'Equipment'
    },
    {
      url: 'https://alkaio.com/media/1183199723969337.jpeg',
      title: 'Modern DJ Controller',
      category: 'Technik'
    },
    {
      url: 'https://alkaio.com/media/1222144119876542.jpeg',
      title: 'Event Atmosphäre',
      category: 'Event'
    }
  ]
      ...
      <div className="max-w-7xl mx-auto">
        <div className="text-center space-y-6 mb-16">
          ...
          <h2 className="text-4xl md:text-5xl lg:text-6xl font-bold text-white leading-tight">
            Professionelle Technik trifft Leidenschaft
          </h2>
          <p className="text-lg md:text-xl text-gray-300/90 max-w-3xl mx-auto leading-relaxed">
            Moderne DJ-Technik und Equipment für unvergessliche Events
          </p>
        </div>
        ...
        <div className="flex flex-col gap-6 max-w-4xl mx-auto">
          {images.map((image, index) => (
            <div
              ...
              className="group relative overflow-hidden rounded-lg cursor-pointer border border-white/10 hover:border-cyan-500/50 transition-all duration-500"
            >
              <img
                src={image.url}
                alt={image.title}
              ...
              <div
                ...
                style={{
                  boxShadow: 'inset 0 0 80px rgba(14, 165, 233, 0.15)'
                }}
              />
            </div>
          ))}
