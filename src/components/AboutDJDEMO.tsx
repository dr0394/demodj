          ...
          <div className="space-y-8">
            <div className="space-y-6">
              ...
              <h2 className="text-4xl md:text-5xl lg:text-6xl font-bold text-white leading-tight">
                80er & 90er Spezialist<br />aus Demmin
              </h2>
              <div className="space-y-4">
                ...
                <p className="text-lg text-gray-300/80 leading-relaxed">
                  Ich bin <strong className="text-white">im Umkreis von 350 km</strong> um Demmin buchbar – das umfasst Mecklenburg-Vorpommern, Berlin, Brandenburg, Schleswig-Holstein und Niedersachsen. Ihre Musikwünsche stehen im Mittelpunkt, und ich passe mich individuell an Ihr Event an.
                </p>
