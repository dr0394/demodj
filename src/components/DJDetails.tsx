      ...
      <div className="max-w-7xl mx-auto">
        <div className="text-center space-y-6 mb-16">
          ...
          <h2 className="text-4xl md:text-5xl lg:text-6xl font-bold text-white leading-tight">
            Die Musik der 80er & 90er
          </h2>
          <p className="text-lg md:text-xl text-gray-300/90 max-w-3xl mx-auto leading-relaxed">
            Spezialisiert auf 80er & 90er Hits mit breitem Repertoire – Rock, Pop, Disco, Dance Classics, Charts und mehr
          </p>
        </div>
          ...
          <div className="space-y-6">
            ...
            <div className="grid grid-cols-2 gap-4">
              {[
                ...
                <div
                  key={index}
                  className="flex items-center gap-3 p-4 bg-white/5 backdrop-blur-sm rounded-lg border border-white/10 hover:bg-white/10 hover:border-cyan-500/30 transition-all duration-300"
                >
                  <Music4 className="w-5 h-5 flex-shrink-0" style={{ color: '#0EA5E9' }} />
