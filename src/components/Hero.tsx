          ...
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            <div className="space-y-8">
              <div className="space-y-3">
                <div className="inline-block border-t border-b py-3 px-12" style={{ borderColor: '#0EA5E950' }}>
                  <p className="text-sm md:text-base uppercase tracking-[0.3em] font-light" style={{ color: '#0EA5E9' }}>
              ...
              <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold text-white leading-tight">
                Ihre Party.<br />Ihre Musik. Ihr Beat.
              </h1>
              ...
              <p className="text-sm sm:text-base md:text-lg text-gray-300/90 leading-relaxed max-w-xl">
                Professioneller DJ-Service für Hochzeiten, Geburtstage, Firmenevents und Partys aller Art.
                Spezialisiert auf 80er & 90er Musik mit moderner Technik und Lichtshow.
              </p>

              <div className="space-y-4 pt-4">
                {[
                  'Professionelle Erfahrung & Technik',
      ...
      <div className="relative z-20 bg-black/50 backdrop-blur-xl border-t border-white/5">
        <div className="max-w-7xl mx-auto px-8 sm:px-12 lg:px-16 py-12">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 md:gap-12">
            {[
              { value: '350km', label: 'Reichweite' },
              { value: '100%', label: 'Zufriedenheit' },
              { value: '80s/90s', label: 'Musikfokus' },
              ...
              <div key={index} className="group text-center space-y-3 cursor-default">
                <div className="relative">
                  <div
                    ...
                    style={{ backgroundImage: 'linear-gradient(to bottom right, #0EA5E9, #06B6D4)' }}
                  >
                    {stat.value}
                  </div>
                  <div
                    className="absolute inset-0 blur-xl opacity-0 group-hover:opacity-100 transition-opacity duration-700"
                    style={{ background: 'linear-gradient(to bottom right, transparent, rgba(14, 165, 233, 0.05), transparent)' }}
                  />
                </div>
                <div
                  className="h-px w-12 mx-auto"
                  style={{ background: 'linear-gradient(to right, transparent, rgba(14, 165, 233, 0.4), transparent)' }}
                />
